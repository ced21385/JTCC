...
public class SportEvent03 extends Event03 {
    ...
    private static final ArrayList<SportEvent03> eventList = new ArrayList<SportEvent03>();

    protected SportEvent03(String name, String place, Date dateTime, int audience, String[] teams, int[] scores, String league) throws ParseException {
        super(name, place, dateTime, audience);
        this.setTeams (teams );
        this.setScores(scores);
        this.setLeague(league);
        SportEvent03 event = this;
        SportEvent03.eventList.add(event);
    }  // SportEvent()
    ...
    public static ArrayList getEventList() {return SportEvent03.eventList;}              // static method, cannot be over-ridden

    public static int getNumberOfObjects() {return SportEvent03.getEventList().size();}  // static method, cannot be over-ridden
