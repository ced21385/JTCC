...
public class SoccerGamePane extends GridPane {
    ...
    public void submit() {
        ...
        try { event = new SoccerGame04(name, place, dateTime, audience, teams, scores, league, weather);} catch (ParseException ex) {}
        ...
        this.getRbGoodWeatherYes().setSelected( ((SoccerGame04)event).isGoodWeather());
        this.getRbGoodWeatherNo ().setSelected(!((SoccerGame04)event).isGoodWeather());
